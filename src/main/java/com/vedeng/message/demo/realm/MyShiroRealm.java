...
public class MyShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        if (user != null) {
            ...
            SimpleAuthenticationInfo authenticationInfo = new SimpleAuthenticationInfo(username,user.getUserPassword(), credentialsSalt, getName());
            Subject subject = SecurityUtils.getSubject();
            Session session = subject.getSession(true);
            session.setAttribute(CodeConstants.CURR_USER, user);
    ...
    public static void main(String[] args) {
        ...
        ByteSource credentialsSalt = ByteSource.Util.bytes("adminss");
